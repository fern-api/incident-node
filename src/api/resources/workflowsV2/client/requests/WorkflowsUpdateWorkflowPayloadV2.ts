 ...
 *     }
 */
export interface WorkflowsUpdateWorkflowPayloadV2 {
    ...
    runs_on_incident_modes: WorkflowsUpdateWorkflowPayloadV2.RunsOnIncidentModes.Item[];
    /** Which incidents should the workflow be applied to? */
    runs_on_incidents: WorkflowsUpdateWorkflowPayloadV2.RunsOnIncidents;
    /** The shortform used to trigger this workflow (only applicable for manual triggers) */
    shortform?: string;
    /** What state this workflow is in */
    state?: WorkflowsUpdateWorkflowPayloadV2.State;
    /** Steps that are executed as part of the workflow */
    steps: IncidentIO.StepConfigPayloadV2[];
}

export namespace WorkflowsUpdateWorkflowPayloadV2 {
