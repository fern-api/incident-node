...
export interface AlertRoutesCreatePayloadV2 {
    ...
    alert_sources: IncidentIO.AlertRouteAlertSourcePayloadV2[];
    /** The channel configuration for this alert route */
    channel_config: IncidentIO.AlertRouteChannelConfigPayloadV2[];
    ...
    enabled: boolean;
    escalation_config: IncidentIO.AlertRouteEscalationConfigPayloadV2;
    /** The expressions used in this template */
    expressions: IncidentIO.ExpressionPayloadV2[];
    incident_config: IncidentIO.AlertRouteIncidentConfigPayloadV2;
    incident_template: IncidentIO.AlertRouteIncidentTemplatePayloadV2;
