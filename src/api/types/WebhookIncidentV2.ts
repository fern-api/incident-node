...
export interface WebhookIncidentV2 {
    ...
    custom_field_entries: IncidentIO.CustomFieldEntryV2[];
    /** Incident duration metrics and their measurements for this incident */
    duration_metrics?: IncidentIO.IncidentDurationMetricWithValueV2[];
    ...
    incident_role_assignments: IncidentIO.IncidentRoleAssignmentV2[];
    incident_status: IncidentIO.IncidentStatusV2;
    /** Incident lifecycle events and when they occurred */
    incident_timestamp_values?: IncidentIO.IncidentTimestampWithValueV2[];
    incident_type?: IncidentIO.IncidentTypeV2;
