...
export interface EscalationV2 {
    ...
    created_at: string;
    creator: IncidentIO.EscalationCreatorV2;
    ...
    events: IncidentIO.EscalationEventV2[];
    /** Unique ID of the escalation */
    id: string;
    priority: IncidentIO.EscalationPriorityV2;
    /** Alerts related to this escalation */
    related_alerts: IncidentIO.AlertSlimV2[];
    /** Incidents related to this escalation */
    related_incidents: IncidentIO.IncidentSlimV2[];
