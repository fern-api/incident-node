...
export interface AlertRouteV2 {
    ...
    alert_sources: IncidentIO.AlertRouteAlertSourceV2[];
    /** The channel configuration for this alert route */
    channel_config: IncidentIO.AlertRouteChannelConfigV2[];
    ...
    enabled: boolean;
    escalation_config: IncidentIO.AlertRouteEscalationConfigV2;
    /** The expressions used in this template */
    expressions: IncidentIO.ExpressionV2[];
    /** Unique identifier for this alert route config */
    id: string;
    incident_config: IncidentIO.AlertRouteIncidentConfigV2;
    incident_template: IncidentIO.AlertRouteIncidentTemplateV2;
