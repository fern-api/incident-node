...
export interface CatalogTypeAttributePayloadV3 {
    ...
    mode?: CatalogTypeAttributePayloadV3.Mode;
    /** Unique name of this attribute */
    name: string;
    /** The path to use (if this is an path) */
    path?: IncidentIO.CatalogTypeAttributePathItemPayloadV3[];
    /** Catalog type name for this attribute */
    type: string;
}

export namespace CatalogTypeAttributePayloadV3 {
    /** Controls how this attribute is modified */
    export const Mode = {
        Empty: "",
        Api: "api",
