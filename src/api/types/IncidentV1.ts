...
export interface IncidentV1 {
    ...
    created_at: string;
    creator: IncidentIO.ActorV1;
    /** Custom field entries for this incident */
    custom_field_entries: IncidentIO.CustomFieldEntryV1[];
    /** Unique identifier for the incident */
    id: string;
    /** A list of who is assigned to each role for this incident */
    incident_role_assignments: IncidentIO.IncidentRoleAssignmentV1[];
    ...
    timestamps?: IncidentIO.IncidentTimestampValueV1[];
